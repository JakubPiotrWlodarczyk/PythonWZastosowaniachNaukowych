#import sys # do odczytania argumentow
import argparse
from collections import Counter # do zliczenia slow w array
from ascii_graph import Pyasciigraph

#input_file_pl = sys.argv[1] # pierwszy argument to plik z ksiazka po polsku
#input_file_en = sys.argv[2] # drugi argument to plik z ksiazka po angielsku

#ile_wyrazow_wyswietlic = sys.argv[3] # trzeci argument okresla ile wyrazow wyswietlic (domyslnie 10)
#minimalna_dlugosc_slowa = sys.argv[4] # czwarty argument okresla minimalna dlugosc slowa wpisywanego do histogramu (domyslnie 0)

#input_file_pl = 'Cierpienia_mlodego_Wertera.txt'
#input_file_en = 'The_Sorrows_of_Young_Werter.txt'
